        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" autocomplete="email" required
                               class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 border border-gray-300 placeholder:text-gray-400 focus:border-2 focus:-border-offset-2 focus:border-indigo-600 sm:text-sm/6"/>
                    </div>
                </div>
            ...
            @if ($errors->any())
                @foreach ($errors->all() as $error)
                    <p class="mt-2 text-sm/6 text-red-600" id="email-error">{{ $error }}</p>
                @endforeach
            @endif
